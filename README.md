...
**Morse Message** is a Ruby script designed to adeptly decode Morse code messages, delivering uppercase translations for individual characters and entire words.
...
```sh
  cd my-folder
  git clone https://github.com/prg-04/Morse-code.git
```
...
Feel free to check the [issues page](https://github.com/prg-04/Morse-code/issues).
